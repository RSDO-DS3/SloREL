...
class Corpus:
    ...
    def get_validation_cnfmat(self, args, model_gat, model_entity_embedding, model_conv, unique_entities_train, unique_entities_test, reuse=True, use_ent_emb_module=False, use_gat_for_getting_test_entities=True, gat_only=True):

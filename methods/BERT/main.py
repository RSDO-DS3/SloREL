...
if __name__ == "__main__":
    ...
    parser.add_argument("--train_file", default="bert_train_data.tsv", type=str, help="Train file")
    parser.add_argument("--test_file", default="bert_validation_data.tsv", type=str, help="Test file")
    ...
    parser.add_argument("--seed", type=int, default=727, help="random seed for initialization")
    parser.add_argument("--train_batch_size", default=40, type=int, help="Batch size for training.")
    parser.add_argument("--eval_batch_size", default=40, type=int, help="Batch size for evaluation.")
    parser.add_argument(
        "--max_seq_len",
        default=100,
        type=int,

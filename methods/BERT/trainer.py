...
class Trainer(object):
    ...
    def save_model(self):
        ...
        if not os.path.exists(self.args.model_dir + "/" + str(self.num)):
            os.makedirs(self.args.model_dir + "/" + str(self.num))
        model_to_save = self.model.module if hasattr(self.model, "module") else self.model
        model_to_save.save_pretrained(self.args.model_dir + "/" + str(self.num))

        # Save training arguments together with the trained model
        torch.save(self.args, os.path.join(self.args.model_dir + "/" + str(self.num), "training_args.bin"))
        logger.info("Saving model checkpoint to %s", self.args.model_dir + "/" + str(self.num))
        self.num += 1

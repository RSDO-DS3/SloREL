...
def predict(sentences):
    ...
    dataset = convert_input_file_to_tensor_dataset(sentences, args, model_dir)
    ...
    results = []
    for pred_out, pred, sentence in zip(preds_out, preds, sentences):
       results.append({"sentence": sentence, "relation": str(label_lst[pred_out]), "score": float(pred[pred_out])})
